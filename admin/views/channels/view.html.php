...
class StreamyViewChannels extends JViewLegacy
{
	protected $items;
	...
	function display($tpl = null) 
	{
		...
		StreamyHelper::addSubmenu('channels');
	...
	{
		JToolBarHelper::title(JText::_('COM_STREAMY_CHANNELS'));
		JToolBarHelper::addNew('channel.add');
		JToolBarHelper::editList('channel.edit');
		JToolBarHelper::divider();
		JToolBarHelper::publishList('channels.publish');
		JToolBarHelper::unpublishList('channels.unpublish');	
		JToolBarHelper::divider();
		JToolBarHelper::deleteList('', 'channels.delete');	
		JToolBarHelper::divider();
		JToolBarHelper::preferences('com_streamy',400,650);		
		
		JHtmlSidebar::setAction('index.php?option=com_streamy&view=channels');
	...
	{
		return array(
			'c.name' => JText::_('COM_STREAMY_CHANNEL_HEADING_NAME'),
			'c.url' => JText::_('COM_STREAMY_CHANNEL_HEADING_URL'),
			'c.chaturl' => JText::_('COM_STREAMY_CHANNEL_HEADING_CHATURL'),
