...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_streamy&task=channeltypes.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_streamy&controller=channeltypes'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<thead>
			<tr>
				...
				<th style="text-align:left;width:30%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_STREAMY_CHANNELTYPE_HEADING_NAME', 'c.name', $listDirn, $listOrder); ?>
				</th>	
				<th class="nowrap">
...
<td>
					<a href="<?php echo JRoute::_('index.php?option=com_streamy&task=channeltype.edit&id=' . $item->id); ?>">
						<?php echo $item->name; ?>
				</a>				
<td align="center" class="hidden-phone">

					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'channeltypes.');?>		
				</td>
