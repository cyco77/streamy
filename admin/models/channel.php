...
class StreamyModelChannel extends JModelAdmin
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_streamy.channel', 'channel', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_streamy.edit.channel.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
